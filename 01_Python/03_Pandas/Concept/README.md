...
| [`DataSet/`](../Data) | 13 small CSVs used by the notebooks and available for practice — salary, income, exam, encoding, PCA, and others. |
...
from a database. Most of these want a real dataset — [`DataSet/`](../Data) has 13.
...
Tracked in [`docs/review-queue.md`](../../../15_Docs/review-queue.md).
